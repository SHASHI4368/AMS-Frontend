...
const Login = () => {
  ...
  const getRegNumber = async (Email) => {
    try {
      const url = `https://api.swargadhi.lk/db/student/regnumber/${Email}`;
  ...
  const handleStdLogin = async (Email, Password) => {
    const getStudentAppointments = async () => {
      try {
        const url = `https://api.swargadhi.lk/db/student/appointments/${regNumber}`;
        const response = await axios.get(url);
    ...
    try {
      const url = `https://api.swargadhi.lk/db/student/login`;
  ...
  const handleStaffLogin = async (Email, Original_password) => {
    ...
    try {
      const url = `https://api.swargadhi.lk/db/staff/login`;
  ...
  const getStaffPassword = async (Email) => {
    try {
      const url = `https://api.swargadhi.lk/db/staff/password/${Email}`;
      const response = await axios.get(url);
  ...
  const checkStaffIsThere = async () => {
    try {
      const url = `https://api.swargadhi.lk/db/staff/${tempEmail}`;
      const response = await axios.get(url);
