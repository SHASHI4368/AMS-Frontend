...
const Login = () => {
  ...
  const { setAuthorized, setRegNumber } = useUIContext();
    ...
    <LoginContainer>
      <LoginPaper>
        ...
        <ButtonContainer>
          ...
          <MyLink onClick={() => navigate('/signup')} color={Colors.dim_grey} underline="hover" sx={{ mt: 5 }}>
