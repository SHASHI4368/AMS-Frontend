...
const Login = () => {
  ...
  const getRegNumber = async (Email) => {
    try {
      const url = `http://194.238.23.116:8080/db/student/regnumber/${Email}`;
  ...
  const handleStdLogin = async (Email, Password) => {
    ...
    try {
      const url = `http://194.238.23.116:8080/db/student/login`;
  ...
  const handleStaffLogin = async (Email, Original_password) => {
    const getStaffAppointments = async () => {
      try {
        const url = `http://194.238.23.116:8080/db/appointments/${Email}`;
        const response = await axios.get(url);
        return response.data;
      } catch (err) {
        console.log(err);
    ...
    try {
      const url = `http://194.238.23.116:8080/db/staff/login`;
  ...
  const getStaffPassword = async (Email) => {
    try {
      const url = `http://194.238.23.116:8080/db/staff/password/${Email}`;
      const response = await axios.get(url);
  ...
  const checkStaffIsThere = async () => {
    try {
      const url = `http://194.238.23.116:8080/db/staff/${tempEmail}`;
      const response = await axios.get(url);
