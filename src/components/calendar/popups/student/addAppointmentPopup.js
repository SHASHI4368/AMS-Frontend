...
const AddAppointmentPopup = () => {
  ...
  const addAppointment = async () => {
    ...
    try {
      ...
      const url = `${process.env.REACT_APP_BACKEND_URL}/db/appointment/add`;
      const data = {
        Id: id,
  ...
  const sendAppointmentAddedMail = async () => {
    ...
    try {
      ...
      const acceptUrl = `${process.env.REACT_APP_BACKEND_URL}/db/appointment/accept/${id}`;
  ...
  const getLastAppointment = async () => {
    try {
      const url = `${process.env.REACT_APP_BACKEND_URL}/db/appointment/last`;
